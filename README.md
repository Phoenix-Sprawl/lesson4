...
.zip compressed folder containing all stages
GitHub repository link
Google Drive link with shared access
File Naming: studentname_stage1.py, studentname_stage2.py, studentname_stage3.py